<x-guest-layout>
    <div class="flex items-center flex-wrap -mx-4 -mt-5">
        ...
        <div class="xl:w-1/2 w-full px-4">
            <div class="mb-7">
                <h1 class="text-center font-16 text-dark_2 dark:text-optm-gray-200 uppercase pb-3 ">
            ...
            @if (settings('registration_active_status'))
                <p class="mt-5 2xl:mt-6 text-dark_2 dark:text-optm-gray-200 font-14 text-center">
