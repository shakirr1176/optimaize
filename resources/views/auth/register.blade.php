    ...
    <div class="flex items-center flex-wrap -mx-4 -mt-3">
        ...
        <div class="xl:w-1/2 w-full px-4">
            <div class="mb-7 mt-7 xl:mt-0">
                <h1 class="text-center text-2xl font-medium text-dark_2 dark:text-optm-gray-200 font-24">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-1 gap-5 2xl:gap-6">
                    <div>
                        <div class="flex items-center lara-input">
                            <div class="ml-[-3px]">
                                @svg('heroicon-o-user', 'w-[23.5px] h-5 mr-2 text-dark_2 dark:text-optm-gray-200')
                            </div>
            ...
            <div>
                <p class="mt-4 2xl:mt-6 text-dark_2 dark:text-optm-gray-200 font-14 text-center">
