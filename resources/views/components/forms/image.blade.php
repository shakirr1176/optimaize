...
<div class="group relative">
    <div class="drop-area flex flex-col justify-center items-center w-full h-32 dark:border-lara-whiteGray border-gray-200 border-2 border-dashed cursor-pointer">
